...
function progressiveJoin(segments: Segment[], budget: number, minLeft: number): { text: string; width: number } {
...
function renderBar(pct: number, width: number, tc: ThemeColors): string {
