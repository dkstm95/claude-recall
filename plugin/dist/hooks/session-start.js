import { applyGitStatus, cleanupOldSessions, createEmptySessionState, getGitStatus, readState, updateState, } from '../state.js';
...
async function handleSessionStart(input) {
    ...
    await updateState(sessionId, (current) => {
        const changedSinceSnapshot = !!current && (existingSnapshot === null || JSON.stringify(current) !== existingSnapshot);
